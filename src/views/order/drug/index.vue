  ...
  <div>
    <a-spin :spinning="spinning">
      <a-table rowKey="orderId" :data-source="data" bordered>
        ...
        <a-table-column title="药品价格" data-index="drugTotalPrice"></a-table-column>
        ...
        <a-table-column title="退款状态" data-index="orderTempStatus">
          <template slot-scope="text, item">
            <span v-if="item.orderTempStatus == 1" style="color: #ee9a00">退款中</span>
            <span v-if="item.orderTempStatus == 2" style="color: #ee9a00">退款成功</span>
          </template>
        </a-table-column>
